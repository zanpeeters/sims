...
header_info = {
    ...
    'AutoCal': {
        ...
        'mass label':           'Species label; 64 characters max. (str)',
    ...
    'HVControl': {
        ...
        'mass label':           'Species label of reference mass; 64 characters max. (str)',
    ...
    'Species': {
        ...
        'mass label':           'Label of species. 64 characters max. (str)',
    ...
    'Trolleys': {
        ...
        'mass label':           'Species name. 64 characters max. (str)',
        'mass':                 'Mass in AMU (float)',
